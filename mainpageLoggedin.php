...
<html lang="en">
  ...
  <body>
    ...
    <li><a href="profile.php">Logged in as <strong><span id="username"><?php session_start(); echo $_SESSION['username']; ?></span></strong></a></li>        
     <li><a href="index.php?logout=1">Log out</a></li></ul>
    </div>
         </div> 
        </nav>
...
<div class="jumbotron">
    <div class="container-fluid">
        ...
        <div class="col-sm-offset-3 col-sm-6">
            <div class="container">
             <div id="error" style="margin-top:-10px;margin-bottom:20px" class="row">
            </div>
            </div>
        ...
        <div id="addnotearea">
            <form><textarea class="form-control" id="textarea" rows="10" name="note"></textarea>
            </form>
        </div>
            <br />
            <br />
